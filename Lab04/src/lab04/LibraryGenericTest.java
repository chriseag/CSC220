...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (!(inventory.get(0).getIsbn()==9780330351690L && inventory.get(1).getIsbn()==9780374292799L)){
    ...
    ArrayList<LibraryBook<String>> authors = lib3.getOrderedByAuthor();
    for(LibraryBook<String> libra: authors) {
    	System.out.println(libra.getAuthor() + " - " + libra.getTitle());
    }
    ...
    lib1.checkout(9780374292799L, "Chris", 10, 26, 2022);
    lib1.checkout(9780330351690L, "Chris", 9, 22, 2023);
    lib1.checkout(9780446580342L, "Chris", 9, 18, 2022);

    
 
    ArrayList<LibraryBook<String>> overdue = lib1.getOverdueList(9, 20, 2022);
 
    
    for(LibraryBook<String> libro: overdue) {
