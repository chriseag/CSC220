...
public class LinkedIntListTester {
	...
	public static void main(String[] args){
		...
		if (!list3.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 1 - you printed: " + list3.toString());
		...
		if (!list4.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 2  - you printed: " + list4.toString());		
		...
		System.out.println(list13.toString());
		...
		System.out.println(list14.toString());
		System.out.println("Testing Done!!!");							
