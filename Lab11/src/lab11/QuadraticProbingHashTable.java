...
public class QuadraticProbingHashTable
{
    ...
    public void insert( int x )
    {
    	...
    	double loadFactor = (double) (currentSize + 1.0) / HashTable.length;
    	if(loadFactor >= 0.75) {
    		rehash();
    	}
    ...
    public void remove( int x )
    {
    	...
    	int index = find(x);
    	HashTable[index] = new HashEntry(x, false);
    	currentSize--;
    	
    	//change size & do not actually remove, only flag
    ...
    public int find( int x )
    {
    	...
    	for(int i = 1; i < HashTable.length; i++) {
    		if (HashTable[(int) (x+(Math.pow(i,2)))%HashTable.length] != null && HashTable[(int) (x+(Math.pow(i,2)))%HashTable.length].element == x){
    			return (int) (x+(Math.pow(i,2)))%HashTable.length;
    		}
    	}
    ...
    public static void main(String[] args){
    	...
    	System.out.println("6: " + h3.toString());
    	...
    	System.out.println("7: " + h3.toString());
    	...
    	System.out.println("8: " + h3.toString());
    	...
    	System.out.println("9: " + h3.toString());
    	
    	if (h3.find(4) != 4)
    		System.err.print("TEST FAILED: find ( 10 )");
    	
    	System.out.println("10: " + h3.find(4));
    	
    	if (h3.find(44) != -1)
    		System.err.print("TEST FAILED: find ( 11 )");
    	
    	System.out.println("11: " + h3.find(44));
    	
    	if (h3.find(77) != 11)
    		System.err.print("TEST FAILED: find ( 12 )");   
    	
    	System.out.println("12: " + h3.find(77));
